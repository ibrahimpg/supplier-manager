...
export default {
  ...
  data() {
    return {
      ...
      postalCode: '',
      country: '',
      productTypeOptions: ['Airline', 'Merchandise', 'Motor Coach', 'No Task', 'Permit', 'Program/Workshop/Clinic', 'Rail', 'Receptive', 'Security', 'Standard Items', 'Tour Director', 'Venue Rental'],
